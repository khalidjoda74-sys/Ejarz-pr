              ...
              builder: (context, constraints) {
                ...
                return Scaffold(
                  ...
                  appBar: wide
                      ? null
                      : AppBar(
                          title: const Text('لوحة إيجارز برو'),
                          actions: <Widget>[
                            IconButton(
...
class _OverviewSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final missing = contracts
        ...
        .length;
    final underReview = contracts
        .where((item) => item.status == ContractStatus.underReview)
        .length;
...
const List<_ContentFieldSpec> _contentFields = <_ContentFieldSpec>[
  ...
  _ContentFieldSpec(
    ...
    defaultValue: 'مرحبًا بك في إيجارز برو',
    minLines: 2,
    maxLines: 3,
  ),
  _ContentFieldSpec(
  ...
  _ContentFieldSpec(
    key: 'homeSubscriptionTitle',
    label: 'عنوان بانر الاشتراك',
    defaultValue: 'الباقة الاحترافية نشطة',
  ),
  _ContentFieldSpec(
    key: 'homeSubscriptionSubtitle',
    label: 'وصف بانر الاشتراك',
    defaultValue: 'يتبقى 12 يومًا على موعد التجديد.',
    minLines: 2,
    maxLines: 3,
  ),
  _ContentFieldSpec(
    key: 'homeSubscriptionAction',
    label: 'زر بانر الاشتراك',
    defaultValue: 'إدارة',
  ),
  _ContentFieldSpec(
    key: 'homeSubscriptionMessage',
    label: 'رسالة زر بانر الاشتراك',
    defaultValue: 'يمكن إدارة الاشتراك من صفحة حسابي.',
    minLines: 2,
    maxLines: 3,
  ),
  _ContentFieldSpec(
