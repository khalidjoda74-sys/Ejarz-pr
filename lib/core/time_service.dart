...
class TimeService {
  ...
  Future<void> ensureSynced({bool force = false}) =>
      KsaTime.ensureSynced(force: force);
  ...
  DateTime ksaStartOfDayUtc([DateTime? baseUtc]) =>
      KsaTime.ksaStartOfDayUtc(baseUtc);
  DateTime ksaEndOfDayUtc([DateTime? baseUtc]) =>
      KsaTime.ksaEndOfDayUtc(baseUtc);
  ...
  DateTime endExclusiveFromStartAndMonthsKsa(
